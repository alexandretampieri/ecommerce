        ...
        <form role="form" action="/admin/products/create" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="desproduct" name="desproduct" placeholder="Digite o nome do produto" maxlength="64">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="vllength">Profundidade (cm)</label>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="desurl" name="desurl" placeholder="Digite a URL" maxlength="128">
            </div>
          </div>
          <!-- /.box-body -->
